  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-2.5 rounded-xl bg-slate-900 text-white space-y-1.5 text-xs">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping"></span>
              <span className="font-bold text-emerald-400 text-[11px]">Live Listener</span>
            </div>
            <span className="text-[9px] text-slate-400">WebSocket Active</span>
          </div>

          {receivedNotification && (
            <div className="p-1.5 rounded bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 text-[11px] font-semibold flex items-center gap-1.5 animate-in fade-in">
          ...
          <button
            ...
            className="w-full py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-emerald-400 font-semibold text-[11px] border border-slate-700 flex items-center justify-center gap-1.5 transition-all"
          >
            {simulatingIncoming ? (
              <>

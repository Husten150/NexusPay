...
export const INITIAL_WALLET: WalletState = {
  ...
  chain: 'Polygon',
  isConnected: true,
  walletType: 'Enterprise Treasury Vault',
...
export const INITIAL_INVOICES: MerchantInvoice[] = [
  {
    ...
    merchantName: 'NexusPay Enterprise Solutions',
    ...
    items: [
      ...
      { id: '2', description: 'Automated Escrow Contract Deployment', quantity: 1, unitPriceUsd: 2200, totalUsd: 2200 },
    ],
    subtotalUsd: 5700,
    taxUsd: 0,
    totalUsd: 5700,
...
export const INITIAL_AUDIT_LOGS: TransactionAuditLog[] = [
  ...
  },
  {
    ...
    txHash: '0xd921...77a4',
    type: 'SECURITY_BLOCK',
    summary: 'Security Guard Blocked Unlimited Token Approval call to suspicious proxy (0xBad...99)',
    amountUsd: 0,
    chain: 'Ethereum',
    status: 'BLOCKED',
    gasFeeUsd: 0.00,

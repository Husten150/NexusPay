...
export const INITIAL_AUDIT_LOGS: TransactionAuditLog[] = [
  {
    id: 'tx-pend-01',
    timestamp: 'Just now (In Mempool)',
    txHash: '0x7e3a89b412fa0982d61b34c90ef81a42b109e512b91c82a472910fae12089b34',
    type: 'TRANSFER_SEND',
    category: 'PENDING',
    summary: 'Transfer Sent: 150.00 USDC to 0x3F91...8D9f1 (Confirmations 2/12)',
    amountUsd: 150.00,
    token: 'USDC',
    cryptoAmount: 150.00,
    recipientAddress: '0x3F91A2d2C5E78bE934607d72863951B421a8D9f1',
  ...
  },
  {
    ...
    txHash: '0x48f91029abce8721948b2019ea81029384756102938475610293847561029384',
    type: 'TRANSFER_RECEIVE',
    category: 'RECEIVED',
    summary: 'Received: +2,500.00 USDC from Horizon Capital Treasury',
    amountUsd: 2500.00,
    token: 'USDC',
    cryptoAmount: 2500.00,
    senderAddress: '0x8811A34f82D991bc8203d985920a0F31a2938Ac1',
  ...
  {
    id: 'tx-swap-01',
    timestamp: '2026-08-20 19:40:15',
    txHash: '0x3102938475610293847561029384756102938475610293847561029384756102',
    type: 'SWAP',
    category: 'SWAP',
    summary: 'DEX Swap: 1.25 ETH → 3,375.00 USDC (Uniswap v3)',
    amountUsd: 3375.00,
    fromToken: 'ETH',
    toToken: 'USDC',
    fromAmount: 1.25,
  ...
  },
  {
    ...
    txHash: '0x9920192837465102938475610293847561029384756102938475610293847561',
    type: 'BUY_CRYPTO',
    category: 'BUY',
    summary: 'Bought: +500.00 USDC with Apple Pay ($500.00 USD On-Ramp)',
    amountUsd: 500.00,
    token: 'USDC',
    cryptoAmount: 500.00,
    fiatAmount: 500.00,
  ...
  },
  {
    ...
    txHash: '0x1209384756102938475610293847561029384756102938475610293847561029',
    type: 'TRANSFER_SEND',
    category: 'SENT',
    summary: 'Transfer Sent: -450.00 XLM to GA7QYNF7SOWQ3GLR2BGMZEHXAVIRZA4KVWLTJJFC7MGXUA74P7UJVSGZ',
    amountUsd: 49.50,
    token: 'XLM',
    cryptoAmount: 450.00,
    recipientAddress: 'GA7QYNF7SOWQ3GLR2BGMZEHXAVIRZA4KVWLTJJFC7MGXUA74P7UJVSGZ',
    senderAddress: 'GAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGUQ2EWKWF4X36S5L33X',
